...
export default function StudentAssignmentsPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight select-none">Assignments</h1>
      ...
      <div className="bg-white rounded-3xl border border-slate-100/80 shadow-3xs p-12 text-center flex flex-col items-center justify-center min-h-[350px]">
        {/* Premium SVG folder illustration */}
        ...
        <h2 className="text-lg font-extrabold text-slate-800 tracking-tight">No Assignments Yet</h2>
        <p className="text-sm text-slate-400 mt-2 max-w-sm leading-relaxed">
          Your active homework, teacher-assigned tasks, and submission history will appear here once published.
        </p>
