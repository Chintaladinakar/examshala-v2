...
export default function WorkspaceRequestFormPage() {
        ...
        <div className="bg-slate-900/60 border border-slate-850 rounded-3xl p-6 md:p-8 w-full shadow-2xl backdrop-blur-3xs space-y-6">
              ...
              <div className="space-y-3.5">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-955 border border-slate-800 rounded-xl text-xs font-semibold focus:outline-none focus:border-teal-500/50"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 bg-slate-955 border border-slate-800 rounded-xl text-xs font-semibold focus:outline-none focus:border-teal-500/50"
                  >
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-slate-955 border border-slate-800 rounded-xl text-xs font-semibold focus:outline-none focus:border-teal-500/50 min-h-24 resize-none"
                  />
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-955 border border-slate-800 rounded-xl text-xs font-semibold focus:outline-none"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-slate-955 border border-slate-800 rounded-xl text-xs font-semibold focus:outline-none"
                    />
                  </div>
                </div>
              </div>
          ...
          {step === 5 && (
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="space-y-3.5 bg-slate-955/60 p-4 border border-slate-850 rounded-2xl text-xs max-h-72 overflow-y-auto">
              ...
              <div className="flex items-start gap-3 bg-slate-955/40 p-3.5 border rounded-xl">
